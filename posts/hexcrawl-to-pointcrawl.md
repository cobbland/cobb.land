...
1. Identify relevant points of interest on the hex map
2. Draw lines between them that make sense (following roads, trails, rivers, et cetera)
3. Using a given games hexcrawling rules, determine how long it would take and how hazardous it would be to travel along each line, as well as which random encounters are relevant.

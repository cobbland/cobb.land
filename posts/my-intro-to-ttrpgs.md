---
title: "My Introduction to TTRPGs"
...
When it came time to actually start a campaign and make our own characters, the group decided 4E wasn't for us (much to the bassist's chagrin), so we explored 3.5E before quickly switching to *[Pathfinder](https://paizo.com/pathfinder)* (1E). As a player, I really enjoyed the system at the time—so many buttons and levers to push and pull, so much mixing and matching of skills and feats and classes and races, so much fiddling—but when it was my turn to run the game, I found *Pathfinder* to be too ridged and brittle in it's rules and application for the stories (hah!) I wanted to tell.
...
By the time *D&D 5E* was actually released, we'd moved on. I was running a *[Star Wars: Edge of the Empire](https://www.edge-studio.net/categories-games/star-wars-eote/)* campaign, which continued through me moving away to Houston, Texas (USA). We played via Google Plus (remember that?), Hangouts, Sheets, and Drawings. The game only lasted a few more months before puttering out.
...
It was then that I made my first foray into old-school gaming, thanks to a [Half Price Books](https://www.hpb.com) that was a few blocks from my apartment (in the Montrose neighborhood for those who know). I stumbled upon a collection of *[Basic D&D](https://en.wikipedia.org/wiki/Dungeons_%26_Dragons_Basic_Set)* and *[Advanced D&D](https://en.wikipedia.org/wiki/Editions_of_Dungeons_%26_Dragons#Advanced_Dungeons_&_Dragons)* adventures for cheap and bought them all up (man, I wish I'd kept all those)—no rulebooks, though. Intrigued, I picked up a pdf of *Basic D&D* and invited my old friends to join me online for a few sessions of *[B1: In Search of the Unknown](https://en.wikipedia.org/wiki/In_Search_of_the_Unknown)*. The game was abandoned after only a single session, and I decided Basic wasn't for me (hah!).

## Story Game Revelations

I couldn't muster my old group to play online and I didn't know anyone in Houston, but I still wanted to play *something*, so I turned to Meetup dot com. There I found [The Gauntlet](https://www.meetup.com/gauntlet-rpg/)!

At that time, [The Gauntlet](https://www.gauntlet-rpg.com) wasn't a publisher of games and producer of podcasts and zines. They were just a local group of story gamers (a local group that continues to this day). I joined their recurring Friday game, which at the time (and usually) was *[Dungeon World](https://www.dungeon-world.com/)*.
...
I started up a (mostly) story games (mostly) one-shots night online using [Roll20](https://roll20.net). At the same time, the bassists got another online 5E campaign going.
...
I convinced my local group to let me run some OSR games. I ran a few sessions of *[Old-School Essentials](https://necroticgnome.com/pages/about-old-school-essentials)* and *[Dungeon Crawl Classics](https://goodman-games.com/dungeon-crawl-classics-rpg/)* (which some would argue isn't OSR, but whatever). *[Death In Space](https://deathinspace.com)* proved fertile soil for a months-long campaign. But even after all that, they wanted to return to 5E.

If I wanted to keep playing OSR games, I figured I was going to have to do so online. And if I was going to run a game online (this time with [Owlbear Rodeo](https://www.owlbear.rodeo)), perhaps I could make a few bucks in the process (on [StartPlaying](https://startplaying.games/gm/cobbland)).
